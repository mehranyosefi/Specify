                    ...
                    {subMenu.solutions && <ul className="transition-all duration-300">
                        <li className="p-3">
                            ...
                            <a href="#designers" className="block relative rounded-xl bg-blue-dark group mt-5">
                                ...
                                <img src="/src/assets/img/designer-puzzle.avif" className="absolute right-28 bottom-8 size-16 transition-all ease-linear duration-[350ms] group-hover:right-20" />
                                <img src="/src/assets/img/designer-waiting.avif" className="absolute size-20 right-2 bottom-2 transition-all ease-linear duration-[350ms] group-hover:-right-1" />
                                <img src="/src/assets/img/designer-alpha.webp" className="absolute size-10 -bottom-1 right-20 transition-all ease-linear duration-[350ms] group-hover:right-14" />
                            </a>
                            <a href="#designers" className="block relative rounded-xl bg-green-dark group mt-2">
                                <div className="py-8 pl-5 text-xl font-semibold">
                                    Developers
                                </div>
                                <img src="/src/assets/img/developers-react.avif" className="absolute right-32 bottom-12 size-10 transition-all ease-linear duration-[350ms] group-hover:right-24" />
                                <img src="/src/assets/img/developers-github.avif" className="absolute size-20 right-2 bottom-2 transition-all ease-linear duration-[350ms] group-hover:-right-1" />
                                <img src="/src/assets/img/developers-dollar.avif" className="absolute size-16 -bottom-1 right-[5.5rem] transition-all ease-linear duration-[350ms] group-hover:right-16" />
                            </a>
                                ...
                                <ul className="list-none p-0 m-0">
                                    <li className="my-4 text-white/80 hover:text-white">
                                        <a className="flex items-center" href="#Documentaions">
                                            <svg className="size-7"><use className="size-5=7" href="/src/assets/img/icons.svg#menu-book"></use></svg><span className="ml-2 text-xl">Documentaions</span>
                                        </a>
                                    </li>
                                    <li className="my-4 text-white/80 hover:text-white">
                                        <a href="#Pars" className="flex items-center">
                                            <svg className="size-7"><use className="size-5=7" href="/src/assets/img/icons.svg#sparss"></use></svg><span className="ml-2 text-xl">Parsers</span>
                                        </a>
                                    </li>
                                    <li className="my-4 text-white/80 hover:text-white group">
                                        <a className="flex items-center" href="#SDTF">
                                            <svg className="size-7"><use className="size-5=7" href="/src/assets/img/icons.svg#light-code"></use></svg><span className="ml-2 text-xl">SDTF</span> <span className="inline-flex px-[.4rem] pb-[.15rem] ml-1 rounded-full bg-purple text-white h-[1.3rem] align-top items-center transition-colors group-hover:bg-white group-hover:text-gray-dark">new</span></a></li>
                                    <li className="my-4 text-white/80 hover:text-white">
                                        <a className="flex items-center" href="#Usecases">
                                            <svg className="size-7"><use className="size-5=7" href="/src/assets/img/icons.svg#view-carousel"></use></svg><span className="ml-2 text-xl">Use cases</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    {subMenu.resources && <ul className="transition-all duration-[400ms]">
                        ...
                        <li className="my-4 hover:text-white">
                            <a className="flex items-center" href="#Customer">
                                <svg className="size-7"><use className="size-7" href="/src/assets/img/icons.svg#people-alt"></use></svg>
                                <span className="ml-2 text-xl">Customer stories</span>
                            </a></li>
                        <li className="my-4 hover:text-white">
                            <a className="flex items-center" href="#Guide">
                                <svg className="size-7"><use className="size-7" href="/src/assets/img/icons.svg#developer-guide"></use></svg>
                                <span className="ml-2 text-xl">Guide</span>
                            </a>
                        </li>
                        <li className="my-4 hover:text-white">
                            <a className="flex items-center" href="#Documentation">
                                <svg className="size-7"><use className="size-7" href="/src/assets/img/icons.svg#menu-book"></use></svg>
                                <span className="ml-2 text-xl">Documentation</span>
                            </a>
                        </li>
                        <li className="my-4 hover:text-white">
                            <a className="flex items-center" href="#Helpcenter">
                                <svg className="size-7"><use className="size-7" href="/src/assets/img/icons.svg#light-help-center"></use></svg>
